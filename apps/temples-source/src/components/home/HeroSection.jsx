        ...
        <div ref={ref} className="relative h-[90vh] w-full overflow-hidden rounded-b-[40px] md:rounded-b-[64px] shadow-elevation-3 perspective-1000">
            ...
            >
                ...
                <motion.h1
                    ...
                    className="font-decorative text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-white mb-6 md:mb-8 leading-tight drop-shadow-2xl px-4"
                >
                ...
                <motion.p
                    ...
                    className="text-white/90 text-base sm:text-lg md:text-2xl max-w-3xl mb-8 md:mb-12 font-serif italic leading-relaxed tracking-wide drop-shadow-md px-6"
                >
